...
require (
	...
	github.com/dolthub/go-mysql-server v0.18.2-0.20240520194022-b5e20763eafa // indirect
	...
	github.com/dolthub/vitess v0.0.0-20240520192903-ff7bd6353f3e // indirect
