...
require (
	...
	github.com/dolthub/go-mysql-server v0.18.2-0.20240521114548-05792f2565eb // indirect
	...
	github.com/dolthub/vitess v0.0.0-20240521104846-e778edc6deb3 // indirect
