...
require (
	...
	github.com/dolthub/go-mysql-server v0.18.2-0.20240429181612-2f42470e893d // indirect
	...
	github.com/dolthub/vitess v0.0.0-20240427075148-bec4421121ee // indirect
