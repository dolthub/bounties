...
require (
	github.com/dolthub/dolt/go v0.40.5-0.20230217173035-9be1e16de9d0
...
require (
	...
	github.com/dolthub/go-mysql-server v0.14.1-0.20230215204931-638b126c00f4 // indirect
	github.com/dolthub/vitess v0.0.0-20230210003150-3065f526d869 // indirect
