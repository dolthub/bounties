...
require (
	...
	github.com/dolthub/go-mysql-server v0.17.1-0.20240209083513-50fb2b2ef1a7 // indirect
	...
	github.com/dolthub/vitess v0.0.0-20240207220624-0c2d2128fb7b // indirect
