...
require (
	github.com/dolthub/dolt/go v0.40.5-0.20230105171548-5b0cc53d2e6f
...
require (
	...
	github.com/dolthub/go-mysql-server v0.14.1-0.20230105143755-86d97438974f // indirect
	github.com/dolthub/vitess v0.0.0-20230105142726-cfbfee9a2946 // indirect
