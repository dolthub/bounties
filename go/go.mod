...
require (
	...
	github.com/dolthub/go-mysql-server v0.18.2-0.20240425194346-88783fbc0ab4 // indirect
	...
	github.com/dolthub/vitess v0.0.0-20240425182414-4147c9af9104 // indirect
