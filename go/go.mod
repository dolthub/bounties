...
require (
	...
	github.com/dolthub/go-mysql-server v0.18.2-0.20240514185251-47f2ce2803f6 // indirect
	...
	github.com/dolthub/vitess v0.0.0-20240514182535-00461f67afae // indirect
