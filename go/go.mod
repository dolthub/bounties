...
require (
	github.com/dolthub/dolt/go v0.40.5-0.20240117200339-ff1e8f75adaf
...
require (
	...
	github.com/dolthub/go-mysql-server v0.17.1-0.20240116235625-e7e445f8a22f // indirect
	...
	github.com/dolthub/vitess v0.0.0-20240110233415-e46007d964c0 // indirect
