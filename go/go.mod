...
require (
	...
	github.com/dolthub/go-mysql-server v0.18.2-0.20240416165030-9a8769166a32 // indirect
	...
	github.com/dolthub/vitess v0.0.0-20240415200146-562b545c47df // indirect
